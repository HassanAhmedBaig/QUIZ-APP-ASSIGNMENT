...
var questions = [
    // Q # 1
    {
        ...
        // Q # 2
    {
        question:"What is the name of our current Prime Minister?",
        name:"username",
        answers:[
            "Nawaz Sharif",
            "Bilawal Bhutoo",
        ...
        // Q # 3
    {
        question:"What color do about 75% of national flags contain?",
        name:"color",
        answers:[
            "Blue",
            "Green",
        ...
        // Q # 7
    {
        ...
        // Q # 8
    {
        question:"What continent is a Japan part of ?",
        name:"continent",
        answers:[
            "Asia",
            "Africa",
        ...
        // Q # 18
    {
        ...
        // Q # 19
    {
        question:"Solve by Quadratic Equation:<br>x<sup>2</sup> - 9x + 8 = 0",
        name:"solve",
        answers:[
            "x = {1, 8}",
            "x = {-1, 8}",
        ...
        // Q # 20
    {
        question:"Solve by Quadratic Equation:<br>z<sup>2</sup> - z - 20 = 0",
        name:"solve2",
        answers:[
            "z = {-4, 5}",
            "z = {-5, 4}",
        ...
        // Q # 21
    {
        ...
        // Q # 22
    {
        question:"Choose the corret spelling",
        name:"spelling",
        answers:[
            "logorria",
            "logorrhea",
